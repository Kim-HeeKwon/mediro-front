...
import {SchedulerHistoryComponent} from "./scheduler-history.component";
...
const schedulerHistoryRoutes: Route[] = [
    {
        path: '',
...
@NgModule({
    ...
    imports: [
        CommonModule,
        RouterModule.forChild(schedulerHistoryRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatFormFieldModule,
        MatIconModule,
...
export class SchedulerHistoryModule {
