...
@Component({
    selector       : 'realgrid-new',
    templateUrl    : './realgrid-new.component.html',
    styleUrls      : ['./realgrid-new.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    animations   : fuseAnimations
})
export class RealgridNewComponent implements OnInit, OnDestroy
{
    ...
    constructor(
        public matDialogRef: MatDialogRef<RealgridNewComponent>,
