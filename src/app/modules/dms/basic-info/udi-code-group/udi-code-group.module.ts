...
import {UdiCodeGroupComponent} from "./udi-code-group.component";
import {UdiCodeGroupResolvers} from "./udi-code-group.resolvers";
...
const udiCodeGroupRoutes: Route[] = [
    {
        path: '',
        component: UdiCodeGroupComponent,
        resolve: {
            data: UdiCodeGroupResolvers
        },
    }
];
@NgModule({
    declarations: [
        UdiCodeGroupComponent
    ],
    imports: [
        CommonModule,
        RouterModule.forChild(udiCodeGroupRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatFormFieldModule,
        MatIconModule,
...
export class UdiCodeGroupModule {}
