...
import {ReportBoundComponent} from "./report-bound.component";
import {ReportBoundResolvers} from "./report-bound.resolvers";

const reportBoundRoutes: Route[] = [
    {
        path: '',
        component: ReportBoundComponent,
        resolve  : {
            data: ReportBoundResolvers
        }
    },
];
...
@NgModule({
    declarations: [
        ReportBoundComponent
    ],
    imports: [
        CommonModule,
        RouterModule.forChild(reportBoundRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatFormFieldModule,
        MatIconModule,
...
export class ReportBoundModule {
