...
const generatePalette = require(path.resolve(__dirname, ('src/@teamplat/tailwind/utils/generate-palette')));
...
const config = {
    ...
    plugins     : [
        ...
        require(path.resolve(__dirname, ('src/@teamplat/tailwind/plugins/extract-config'))),
        require(path.resolve(__dirname, ('src/@teamplat/tailwind/plugins/utilities'))),
        require(path.resolve(__dirname, ('src/@teamplat/tailwind/plugins/icon-size'))),
        require(path.resolve(__dirname, ('src/@teamplat/tailwind/plugins/theming')))({themes}),
